 ...
 * relational operators to read, write, asllocate, and de-allocate pages.
...
public class BufMgr implements GlobalConst {
    ...
    // public int totPageRequests = 0;
    // public int pageLoadHits = 0;
    // public int pageLoadRequests = 0;
    // public int uniquePageLoads = 0;
    public int pageFaults = 0;
    int[][] pageRefCount = new int[300][3];
...
// Function to sort by column 
    ...
    //print counts:
    System.out.println("totPageHits: "+pageHits);
    ...
    float BHR = (float) ((float)pageHits/(float)pageFaults); //replce -1 with the formula   
    // int pageLoadBHR = -1;  //replce -1 with the formula  
  
    System.out.print(" BHR (BHR1): ");
    System.out.printf("%f", BHR);
